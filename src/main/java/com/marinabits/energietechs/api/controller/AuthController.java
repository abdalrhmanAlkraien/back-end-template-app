...
import com.marinabits.energietechs.api.model.request.AuthRequest;
...
import com.marinabits.energietechs.api.model.request.TokenRefreshRequest;
import com.marinabits.energietechs.api.model.response.TokenRefreshResponse;
...
public class AuthController {
    ...
    public TokenRefreshResponse refreshToken(@RequestBody @Valid TokenRefreshRequest tokenRefreshRequest) {
        ...
        return this.userService
                ...
                .map(user ->
                        new TokenRefreshResponse(JwtTokenHelper.generateJwtToken(
                                user.getId(),
                                user.getUsername(),
                                user.getAuthorities()), user.getRefreshToken().toString())
                )
