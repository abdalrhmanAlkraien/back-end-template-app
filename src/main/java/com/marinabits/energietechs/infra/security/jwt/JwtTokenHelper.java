package com.marinabits.energietechs.infra.security.jwt;
...
public final class JwtTokenHelper {
    ...
    public static String generateJwtToken(int id, String username,
        ...
        return Jwts
                ...
                .setExpiration(Date.from(ZonedDateTime.now()
                        ...
                        .toInstant()))
                .addClaims(Map.of("roles", authorities.stream().map(
    ...
    public static Optional<User> getUserFromSecurityContext() {
    ...
    private static class JwtConfig {
        ...
        static final String ISSUER = "marinabits.com";
        static final int TOKEN_EXPIRY_DURATION = 5; // In days
